...
class TrelloControllerTest {
    ...
    void shouldFetchTrelloBoards() throws Exception {
        ...
        List<TrelloBoardDto> trelloBoards = List.of(new TrelloBoardDto("TestList", "1", trelloLists));
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].name", Matchers.is("TestList")))
